...
def newQuery(newAnimal, wrongAnimal):
    ...
    question = tk.simpledialog.askstring('I give up', 'What is a question that would differentiate a ' + newAnimal + ' from a ' + wrongAnimal + '?')
...
try:
    with open(datafile, 'rb') as f:
        ...
        if not hasattr(knowledgeBase, 'animals'):
            raise AttributeError("Invalid data file: missing 'animals' attribute.")
